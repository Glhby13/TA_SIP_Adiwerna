                                    ...
                                    @foreach ($dataBimbingans as $data)
                                        @if ($data['bimbingan']->status == 'Sudah Mengumpulkan')
                                            <tr>
                                                ...
                                                <td>{{ $data['bimbingan']->jumlah_revisi > 0 ? $data['bimbingan']->jumlah_revisi : ' ' }}</td>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                                            <label class="form-label" style="color: #000000;">Revisi ke-</label>
                                                                            <input type="text" class="form-control" name="jumlah_revisi" id="jumlah_revisi" value="{{ $data['bimbingan']->jumlah_revisi + 1 }}" readonly>
                                                                        </div>                                                      
                                                                        <div class="mb-3">
                                                                            <label class="form-label" style="color: #000000;">Catatan Revisi</label>
                                                                            <textarea name="catatan_revisi" id="catatan_revisi"
                                                                                class="border rounded-0 form-control summernote" rows="6"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modalfooter" style="display: flex; justify-content: flex-end; padding-inline: 1rem;">
