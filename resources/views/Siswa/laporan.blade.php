            ...
            <div class="row">
                <div class="col-6" style="padding-left : 200px; padding-right: 100px">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="text-field">
                            @if (in_array($bimbinganSiswa->status, ['Sudah Mengumpulkan', 'Sudah Revisi', 'ACC']))
                                <input class="form-control" style="font-size: 14px;" type="text"
                    ...
                    <div class="btnlaporan" style="justify-content: start; display: flex">
                        @if ($bimbinganSiswa->status == 'Belum Mengumpulkan')
                            <!-- Tombol Submit -->
                            <button type="submit" name="action" value="submit" class="btn" style="background-color: #44B158; color: #ffffff;">Submit</button>
                        @elseif ($bimbinganSiswa->status == 'Revisi')
                            <!-- Tombol Update -->
                            <button type="submit" name="action" value="update" class="btn" style="background-color: #1F3397; color: #ffffff;">Update</button>
                        @endif
                    </div>
                </div>
            </div>
