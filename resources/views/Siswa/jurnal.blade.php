        ...
        <form action="{{ route('submit.jurnal') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-6" style="padding-left: 70px; padding-right: 200px">
                    ...
                    <div class="btnshowjurnal" style="justify-content: end; display: flex; margin-top: 5vh">
                    <a href="{{ route('siswa.jurnaldata') }}"><button type="button" class="btn"
                        style="background-color: #2A356C; color: #ffffff; font-size: 16px;">
                        <i class="fa-solid fa-book mr-2 ml-1"></i>
